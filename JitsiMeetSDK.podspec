Pod::Spec.new do |s|
  s.name             = 'JitsiMeetSDKCuemeTechuick'
  s.version          = '4.1.0'
  ...
  s.homepage         = 'https://github.com/Techuick/jitsi-meet-ios-sdk-releases'
  s.license          = 'Apache 2'
  s.authors          = 'The Jitsi Meet project authors'
  s.source           = { :git => 'https://github.com/Techuick/jitsi-meet-ios-sdk-releases.git', :tag => s.version }
